...
export const MOCK_TENANTS: Tenant[] = [
  { id: '1', name: 'Alice D.', residenceId: ResidenceID.NORTH, originName: 'Université des Sciences', originType: EntityType.SCHOOL, cursus: 'Sciences (Bio, Physique...)', studyYear: 'Master 1', duration: '2 ans', status: PersonStatus.TENANT },
  { id: '2', name: 'Bob M.', residenceId: ResidenceID.NORTH, originName: 'Université des Sciences', originType: EntityType.SCHOOL, cursus: 'Informatique / Numérique', studyYear: 'Licence 3', duration: '10 mois', status: PersonStatus.TENANT },
  ...
  { id: '4', name: 'Diane L.', residenceId: ResidenceID.SOUTH, originName: 'Business School A', originType: EntityType.SCHOOL, cursus: 'Commerce / Marketing', studyYear: 'Master 2', duration: '6 mois', status: PersonStatus.TENANT },
  ...
  { id: '10', name: 'Jean L.', residenceId: ResidenceID.EAST, originName: 'Faculté de Médecine', originType: EntityType.SCHOOL, cursus: 'Médecine / Santé', studyYear: 'Interne', duration: '3 ans', status: PersonStatus.TENANT },
  ...
  { id: '101', name: 'Thomas V.', residenceId: ResidenceID.CENTER, originName: 'École d\'Art', originType: EntityType.SCHOOL, cursus: 'Arts / Design', studyYear: 'Terminale', status: PersonStatus.PROSPECT },
  { id: '102', name: 'Sarah B.', residenceId: ResidenceID.NORTH, originName: 'Lycée International', originType: EntityType.SCHOOL, cursus: 'Lettres / Langues', studyYear: 'Terminale', status: PersonStatus.PROSPECT },
];
